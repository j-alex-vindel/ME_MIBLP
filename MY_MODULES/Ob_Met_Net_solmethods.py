...
def CB_sol_2_NOP(network:M_Network=None,k:Ks=None,log:bool=True,speed:bool=False) -> Result_cb:
    '''
...
def MILP_solve_NOP(network:M_Network=None,k:Ks=None,log:bool=True,speed:bool=False) -> Result:
    '''
