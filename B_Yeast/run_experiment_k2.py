...
m = MILP_solve_NOP(network=metnet,k=2,log=False)
cb = CB_sol_2_NOP(network=metnet,k=2,log=False)
...
file_name_r = f"../Results/Methods_K{sys.argv[0][-4]}_{metnet.Name}.csv"
...
file_name_ri = f"../Results/IC_K{sys.argv[0][-4]}_{metnet.Name}.csv"
